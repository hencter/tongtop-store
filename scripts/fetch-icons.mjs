...
const WANTED = {
  ...
  "agent:aider": [{ fav: "aider.chat" }, { i: "simple-icons:aider" }],
  ...
  "agent:copilot": [{ i: "simple-icons:githubcopilot" }],
  "agent:opencode": [{ fav: "opencode.ai" }],
  "agent:codebuddy": [{ fav: "www.codebuddy.ai" }],
  "agent:amp": [{ fav: "ampcode.com" }],
  "agent:interpreter": [{ fav: "openinterpreter.com" }],
  "agent:claude-desktop": [{ i: "simple-icons:anthropic", c: "#D97757" }],
  "agent:lmstudio": [{ fav: "lmstudio.ai" }],
  "agent:cherrystudio": [{ fav: "cherry-ai.com" }],
  "agent:chatbox": [{ fav: "chatboxai.app" }],
  "agent:jan": [{ fav: "jan.ai" }],
  "agent:gpt4all": [{ fav: "www.nomic.ai" }],

  // ---- 包管理器（已安装页分栏）----
  "tool:npm": [{ i: "logos:nodejs-icon" }, { i: "simple-icons:nodedotjs", c: "#5FA04E" }],
  "tool:pnpm": [{ i: "simple-icons:pnpm", c: "#F69220" }, { i: "logos:pnpm" }],
  "tool:yarn": [{ i: "simple-icons:yarn", c: "#2C8EBB" }, { i: "logos:yarn" }],
  "tool:bun": [{ i: "simple-icons:bun" }],
  "tool:pip": [{ i: "logos:python" }],
  "tool:uv": [{ fav: "docs.astral.sh" }],
  "tool:cargo": [{ i: "simple-icons:rust" }],
  "tool:go": [{ i: "logos:go" }, { i: "simple-icons:go", c: "#00ADD8" }],
  "tool:dotnet": [{ i: "simple-icons:dotnet", c: "#512BD4" }],
  "tool:ruby": [{ i: "simple-icons:ruby", c: "#CC342D" }, { i: "logos:ruby" }],

  // ---- GitHub 专区补充（目录里已有的开源软件）----
  "kangfenmao.cherrystudio": [{ fav: "cherry-ai.com" }],
